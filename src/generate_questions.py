...
def generate_questions():
    ...
    llm = ChatOpenRouter(
        openai_api_key=OPENROUTER_API_KEY, model_name="openai/gpt-4o-2024-11-20"
    )
    prompt = PromptTemplate.from_template(
        """You are a novel user of the Uniform Network Code (UNC) for the UK gas network. The following context is a snippet of the UNC. Create a question you may have about this text. Here are examples of questions (not necessarily based on the given text):
